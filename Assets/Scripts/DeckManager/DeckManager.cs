...
/*                        if (clickImages != null) //unsure what this used to do, doesn't seem needed anymore - leave for now just in case
        ...
        if (doubleClick == false)
        {
            ...
            cardInstance.SetProperties(card.id, card.ergoTokenId, card.ergoTokenAmount, card.cardName, card.cardDescription, card.attack, card.HP, card.gold, card.XP, card.fieldLimit, card.fieldPosition, card.clan, card.levelRequired, card.image.sprite, card.frame.sprite, card.cardClass, card.ability
    ...
    private void Init() // Initilize when user click on new deck
    {
        ...
        {
            Card cardInstance = Instantiate<Card>(cardPrefabs, availableListOfCard.transform);
            cardInstance.SetProperties(matchedCardListForAvailable[i].id, matchedCardListForAvailable[i].ergoTokenId, matchedCardListForAvailable[i].ergoTokenAmount, matchedCardListForAvailable[i].cardName, matchedCardListForAvailable[i].cardDescription, matchedCardListForAvailable[i].attack, matchedCardListForAvailable[i].HP, matchedCardListForAvailable[i].gold, matchedCardListForAvailable[i].XP, matchedCardListForAvailable[i].fieldLimit, matchedCardListForAvailable[i].fieldPosition, matchedCardListForAvailable[i].clan, matchedCardListForAvailable[i].levelRequired, matchedCardListForAvailable[i].cardImage, matchedCardListForAvailable[i].cardFrame, matchedCardListForAvailable[i].cardClass, matchedCardListForAvailable[i].ability
