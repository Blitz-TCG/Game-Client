...
public class Mimic : Card
{
    public void SetMimicData(Card fromCard, Card toCard)
    {
        ...
        toCard.SetMiniCard(fromCard.id, toCard.ergoTokenId == null ? "" :  toCard.ergoTokenId, toCard.ergoTokenAmount == 0 ? 0 :  toCard.ergoTokenAmount, toCard.cardName == null ? "" : toCard.cardName, fromCard.attack, fromCard.HP, fromCard.gold, fromCard.XP, toCard.cardImage, fromCard.ability);
